...
export function preloadAssets(scene: MercatorumLabScene): void {
  try {
    ...
    scene.load.spritesheet('doctor', 'assets/characters/doctor_spritesheet.png', { 
      frameWidth: 32, 
      frameHeight: 48 
    });
