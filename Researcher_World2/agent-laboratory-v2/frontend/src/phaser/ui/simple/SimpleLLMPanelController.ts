...
export class SimpleLLMPanelController {
  ...
  /**
   * Restituisce il modello utilizzato da questo controller
   * @returns Il modello SimpleLLMPanelModel
   */
  public getModel(): SimpleLLMPanelModel {
    return this.model;
  }
